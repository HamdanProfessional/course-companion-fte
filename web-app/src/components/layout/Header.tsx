          ...
          {!isTeacher && (
            <>
              ...
              <div className="relative group">
                <button className="px-2 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-1.5 text-text-secondary hover:text-cosmic-primary hover:bg-cosmic-primary/10 whitespace-nowrap">
                  <Target className="w-4 h-4 flex-shrink-0" />
                  <span className="hidden 2xl:inline">Learning Tools</span>
                </button>
