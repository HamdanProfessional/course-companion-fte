...
Simplified version without code examples that cause syntax errors.
"""
...
# Simple course content (4 chapters)
CHAPTERS_DATA = [
    {
        "order": 1,
...
AI agents have three main components: Sceptors to perceive the environment, a processing core to reason and make decisions, and actuators to take actions in the environment.
""",
        "quiz": {
            "questions": [
                {
